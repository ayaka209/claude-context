...
module.exports = {
    ...
    resolve: {
        ...
        extensions: ['.ts', '.js'],
        alias: {
            '@ayaka209/claude-context-core': path.resolve(__dirname, '../core/dist/index.js'),
            '@ayaka209/claude-context-core/dist/splitter': path.resolve(__dirname, '../core/dist/splitter'),
            '@ayaka209/claude-context-core/dist/embedding': path.resolve(__dirname, '../core/dist/embedding'),
            '@ayaka209/claude-context-core/dist/vectordb': path.resolve(__dirname, '../core/dist/vectordb')
        }
    },
    module: {
        rules: [
