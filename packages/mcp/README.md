...
[![npm version](https://img.shields.io/npm/v/@ayaka209/claude-context-mcp.svg)](https://www.npmjs.com/package/@ayaka209/claude-context-mcp)
[![npm downloads](https://img.shields.io/npm/dm/@ayaka209/claude-context-mcp.svg)](https://www.npmjs.com/package/@ayaka209/claude-context-mcp)
...
claude mcp add claude-context -e OPENAI_API_KEY=your-openai-api-key -e MILVUS_TOKEN=your-zilliz-cloud-api-key -- npx @ayaka209/claude-context-mcp@latest
...
- **[@ayaka209/claude-context-core](../core)** - Core indexing engine used by this MCP server
